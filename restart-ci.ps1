...
# ---------------------------------------------------------------
$jvmServices = @("igaming-aggregator-ingestion", "igaming-aggregator-api", "igaming-aggregator-surebet", "igaming-aggregator-odds-sync", "igaming-bot", "igaming-portal", "igaming-admin-backend", "igaming-llm-gateway", "igaming-llm-admin", "igaming-llm-worker", "service-proxy-backend", "igaming-auth-microservice", "igaming-capture-sofascore", "igaming-capture-liveresult")

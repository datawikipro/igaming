...
public class BetfairOddsMapper {
    ...
    private void processOdd(String eventId, BetfairOdd odd, SportType sportType, String sportName, List<OddItem> oddsList) {
    ...
    private BetType resolveBetType(BetfairOdd odd, SportType sportType, String marketName, String runnerName) {
        String mUpper = marketName.toUpperCase();
        String codeUpper = odd.getCode().toUpperCase();

        // 1. Result Markets
        if (mUpper.contains("MATCH ODDS") || mUpper.contains("MATCH WINNER") || mUpper.contains("MATCH BETTING")) {

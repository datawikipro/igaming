...
import pro.datawiki.igaming.source.bwin.dto.kambi.KambiBetOffer;
import pro.datawiki.igaming.source.bwin.dto.kambi.KambiEvent;
import pro.datawiki.igaming.source.bwin.dto.kambi.KambiEventDetailsResponse;
import pro.datawiki.igaming.source.bwin.dto.kambi.KambiOutcome;
...
public class BwinOddsMapper {
    ...
    public OddsUpdateRequest mapToOddsUpdateRequest(KambiEventDetailsResponse response, String fallbackSport, String fallbackLeague) {
        ...
        request.setEventUrl("https://www.bwin.com/betting/sports/event/" + event.getId());
    ...
    private BetType resolveBetType(KambiBetOffer betOffer, KambiOutcome outcome, SportType sportType, 
        ...
        return betTypeResolver.resolve("bwin", sportType, mUpper, runnerName.toUpperCase(), line);
    }
    ...
    private void logUnmapped(KambiEvent event, String sportName, String marketName, String runnerName) {
        ...
        unmappedBetService.saveAndNotify("bwin", sportName, runnerName, marketName, String.valueOf(event.getId()));
    }
}

...
SET k3s_server_url    = 'https://100.86.137.112:6443',
    k3s_token         = 'K10c7e23826108f187591e9533b0f508af002ac6670d728c57e0b4919cac2725b15::server:84cc0f96d1b83f1620ba81127b42d739',
    tailscale_auth_key = 'tskey-auth-kGSVQGHSbc11CNTRL-6uiQBZMqfqMNy5XcNwXdqM69pD18cdih'
WHERE name = 'betting_hacker';

-- Update test1 (priority=2, europe-north1)
-- Uses the same k3s cluster (master reachable via Tailscale 100.86.137.112)
UPDATE cloud_accounts
SET k3s_server_url    = 'https://100.86.137.112:6443',
    k3s_token         = 'K10c7e23826108f187591e9533b0f508af002ac6670d728c57e0b4919cac2725b15::server:84cc0f96d1b83f1620ba81127b42d739',
    tailscale_auth_key = 'tskey-auth-kGSVQGHSbc11CNTRL-6uiQBZMqfqMNy5XcNwXdqM69pD18cdih'

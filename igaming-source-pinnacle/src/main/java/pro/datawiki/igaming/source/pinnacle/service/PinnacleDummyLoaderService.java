...
@Service
@Slf4j
public class PinnacleDummyLoaderService extends AbstractBaseBookmakerService {

    public PinnacleDummyLoaderService(MatchCacheRepository matchCacheRepository,
    ...
    protected boolean loadSingleMatchCard(MatchCache cache) {
        log.debug("Loader: Pinnacle uses direct crawler-pushed model. Marking match {} as PROCESSED.", cache.getExternalId());

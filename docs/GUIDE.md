...
3. [OpenSpec (Spec-Driven Development)](#3-openspec-spec-driven-development)
4. [Архитектура системы](#4-архитектура-системы)
5. [Микросервисы и модули](#5-микросервисы-и-модули)
6. [Kubernetes-инфраструктура](#6-kubernetes-инфраструктура)
7. [Правила расстановки нод (Node Scheduling)](#7-правила-расстановки-нод-node-scheduling)
8. [Букмекеры и источники данных](#8-букмекеры-и-источники-данных)
9. [CI/CD и деплой](#9-cicd-и-деплой)
10. [Локальная разработка](#10-локальная-разработка)
11. [Частые проблемы и их решение](#11-частые-проблемы-и-их-решение)
...
Проект разделён на следующие репозитории:
...
| `C:\Users\chernousov_a\IdeaProjects\igaming-openspec` | **OpenSpec Store** | Централизованный репозиторий спецификаций и требований ([datawikipro/igaming-openspec](https://github.com/datawikipro/igaming-openspec.git)) |
...
Все архитектурные решения, изменения и критерии приёмки (DoD) зафиксированы в стандарте OpenSpec.
Подробная документация: [`docs/OPENSPEC.md`](OPENSPEC.md).

Команды управления изменениями:
- `/opsx-propose` — создание предложения изменения (proposal, delta specs, design, tasks).
- `/opsx-apply` — применение задач по спецификации.
- `/opsx-archive` — архивация после прохождения 5-минутного DoD в K8s.
- `openspec validate --specs` — валидация спецификаций перед открытием PR.

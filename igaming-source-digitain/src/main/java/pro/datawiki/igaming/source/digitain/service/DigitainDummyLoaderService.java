...
@Service
public class DigitainDummyLoaderService extends AbstractBaseBookmakerService {

    public DigitainDummyLoaderService(MatchCacheRepository matchCacheRepository,
